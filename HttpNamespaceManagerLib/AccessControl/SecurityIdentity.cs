...
namespace HttpNamespaceManager.Lib.AccessControl
{
    ...
    public class SecurityIdentity
    {
        ...
        public static bool operator==(SecurityIdentity obj1, SecurityIdentity obj2)
        {
            ...
            else if (ReferenceEquals(obj1, null) || ReferenceEquals(obj2, null)) return false;
        ...
        public static bool operator !=(SecurityIdentity obj1, SecurityIdentity obj2)
        {
            ...
            else if (ReferenceEquals(obj1, null) || ReferenceEquals(obj2, null)) return true;
            return !obj1.Equals(obj2);
        }
        ...
        public static WELL_KNOWN_SID_TYPE GetWellKnownSidTypeFromSddlAbbreviation(string abbreviation)
        {
            ...
            return (WELL_KNOWN_SID_TYPE)Array.IndexOf<string>(wellKnownSidAbbreviations, abbreviation);
        }
